...
const options = [
  {
    ...
    description:
      "Challenge your Spanish skills by answering questions and getting instant feedback on your answers.",
    href: "questions",
  },
  {
    label: "Practice conversations",
    description:
      "Engage in interactive conversations to improve your speaking and listening skills in Spanish.",
    href: "conversations",
  },
  {
...
export default async function LanguageInfoPage({
  params,
}: {
        ...
        <header className="space-y-4">
          ...
          <div className="flex gap-2">
            <SuspendedItem
              ...
              result={(info) => (
                <Badge variant="secondary">{formatExperienceLevel(info.experienceLevel)}</Badge>
              )}
            />
            <SuspendedItem
              item={languageInfo}
