  ...
  return (
    <div className="container my-4">
      <div className="flex gap-2 justify-between mb-6">
        <h1 className="text-3xl md:text-4xl lg:text-5xl">Select a language description</h1>
        <Button asChild>
                ...
                <div className="space-y-4 h-full flex-1 min-w-0">
                  ...
                  <CardFooter className="flex gap-2">
                    <Badge variant="outline">
                      {formatExperienceLevel(languageInfo.experienceLevel)}
                    </Badge>
  ...
  return (
    <div className="container my-4 max-w-5xl">
      ...
      <p className="text-muted-foreground mb-8">
        To get started, add a new language info to enhance your learning experience!
      </p>
      <Card>
        <CardContent>
          <LanguageInfoForm />
